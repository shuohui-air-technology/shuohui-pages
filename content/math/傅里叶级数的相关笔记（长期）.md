...
$$a_n = \frac{1}{\pi} \int_{0}^{\pi} x\cos(nx) \,dx = \frac{1}{\pi} \left( \left[ x \frac{\sin(nx)}{n} \right]\_0^\pi - \int\_{0}^{\pi} \frac{\sin(nx)}{n} \,dx \right) = \frac{(-1)^n - 1}{\pi n^2}$$

计算 $b_n$ （使用分部积分法）：

$$b_n = \frac{1}{\pi} \int_{0}^{\pi} x\sin(nx) \,dx = \frac{1}{\pi} \left( \left[ -x \frac{\cos(nx)}{n} \right]\_0^\pi + \int\_{0}^{\pi} \frac{\cos(nx)}{n} \,dx \right) = \frac{(-1)^{n+1}}{n}$$
...
$$b_n = \frac{2}{\pi} \left( \left[ -x \frac{\cos(nx)}{n} \right]\_0^\pi + \int\_{0}^{\pi} \frac{\cos(nx)}{n} \,dx \right) = \frac{2}{\pi} \left( -\frac{\pi (-1)^n}{n} + 0 \right) = 2 \frac{(-1)^{n+1}}{n}$$
